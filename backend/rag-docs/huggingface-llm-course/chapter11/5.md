...
title: "Evaluation"
chapter: "chapter11"
original_path: "chapters/en/chapter11/5.mdx"
source_revision: "5805d51523d561a82520b301dbc8c5759b212844"
source_url: "https://github.com/huggingface/course/blob/5805d51523d561a82520b301dbc8c5759b212844/chapters/en/chapter11/5.mdx"
---
# Evaluation
...
**Choices**
- They provide perfect real-world performance metrics
  - Explanation: Incorrect! While automatic benchmarks are useful, they don't always translate directly to real-world performance.
- They allow for standardized comparison between models and provide reproducible results
  - Explanation: Correct! This is one of the key benefits of automatic benchmarks.
- They eliminate the need for any other form of evaluation
  - Explanation: Incorrect! Automatic benchmarks should be part of a comprehensive evaluation strategy, not the only method.

### 2. Which benchmark specifically tests knowledge across 57 different subjects?

**Choices**
- BBH (Big Bench Hard)
  - Explanation: Incorrect! BBH focuses on complex reasoning tasks, not broad subject knowledge.
- GSM8K
  - Explanation: Incorrect! GSM8K specifically targets mathematical problem-solving.
- MMLU
  - Explanation: Correct! MMLU (Massive Multitask Language Understanding) tests knowledge across 57 subjects, from science to humanities.

### 3. What is LLM-as-Judge?

**Choices**
- Using one language model to evaluate another's outputs
  - Explanation: Correct! This is an alternative evaluation approach that can provide more nuanced feedback.
- A benchmark that tests judicial reasoning
  - Explanation: Incorrect! LLM-as-Judge refers to using one model to evaluate another, not testing judicial reasoning.
- A method for training models on legal datasets
  - Explanation: Incorrect! This isn't related to training on legal data, but rather using one model to evaluate another's outputs.

### 4. What should be included in a comprehensive evaluation strategy?

**Choices**
- Only standard benchmarks
  - Explanation: Incorrect! A comprehensive strategy should include multiple evaluation methods.
- Standard benchmarks, custom evaluation datasets, and domain-specific testing
  - Explanation: Correct! A comprehensive strategy should include multiple layers of evaluation.
- Only custom datasets specific to your use case
  - Explanation: Incorrect! While custom datasets are important, they shouldn't be the only evaluation method.

### 5. What is a limitation of automatic benchmarks?

**Choices**
- They are too expensive to run
  - Explanation: Incorrect! Cost isn't typically the main limitation of automatic benchmarks.
- Benchmark performance doesn't always translate directly to real-world effectiveness
  - Explanation: Correct! This is a key limitation to keep in mind when using automatic benchmarks.
- They can only evaluate small models
  - Explanation: Incorrect! Automatic benchmarks can be used to evaluate models of various sizes.

### 6. What is the purpose of creating custom evaluation datasets?

**Choices**
- To reflect your specific use case and include real user queries from your domain
  - Explanation: Correct! Custom datasets help ensure evaluation is relevant to your specific needs.
- To replace standard benchmarks entirely
  - Explanation: Incorrect! Custom datasets should complement, not replace, standard benchmarks.
- To make evaluation easier
  - Explanation: Incorrect! Creating custom datasets requires additional effort but provides more relevant evaluation.
