...
chapter: "chapter11"
original_path: "chapters/en/chapter11/3.mdx"
source_revision: "5805d51523d561a82520b301dbc8c5759b212844"
source_url: "https://github.com/huggingface/course/blob/5805d51523d561a82520b301dbc8c5759b212844/chapters/en/chapter11/3.mdx"
---
...
[Embedded course media](https://huggingface.co/datasets/HuggingFaceTB/smoltalk/embed/viewer/all/train?row=0)
...
**Choices**
- num_train_epochs and max_steps
  - Explanation: Correct! These parameters determine how long the model will train, either by number of epochs or total steps.
- batch_size and learning_rate
  - Explanation: While these affect training, they don't directly control the duration.
- gradient_checkpointing and warmup_ratio
  - Explanation: These parameters affect training efficiency and stability, not duration.
...
- Validation loss increases while training loss continues to decrease
  - Explanation: Correct! This divergence between training and validation loss is a classic sign of overfitting.
- Both training and validation loss decrease steadily
  - Explanation: This pattern actually indicates healthy training.
- Training loss remains constant while validation loss decreases
  - Explanation: This would be an unusual pattern and doesn't indicate overfitting.

### 3. What is gradient_accumulation_steps used for?

**Choices**
- To increase effective batch size without using more memory
  - Explanation: Correct! It accumulates gradients across multiple forward passes before updating weights.
- To save checkpoints during training
  - Explanation: This is handled by save_steps and save_strategy parameters.
- To control the learning rate schedule
  - Explanation: Learning rate scheduling is controlled by learning_rate and warmup_ratio.

### 4. What should you monitor during SFT training?

**Choices**
- Both quantitative metrics and qualitative outputs
  - Explanation: Correct! Monitoring both types of metrics helps catch all potential issues.
- Only the training loss
  - Explanation: Training loss alone isn't sufficient to ensure good model behavior.
- Only the model's output quality
  - Explanation: While important, qualitative evaluation alone misses important training dynamics.

### 5. What indicates healthy convergence during training?

**Choices**
- A small gap between training and validation loss
  - Explanation: Correct! This indicates the model is learning generalizable patterns.
- Training loss reaching zero
  - Explanation: Extremely low loss values might indicate memorization rather than learning.
- Validation loss being lower than training loss
  - Explanation: This would be unusual and might indicate problems with the validation set.
